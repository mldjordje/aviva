...
// NOTE: Archived layout for the original "O nama" page before we switched
// to the under-construction placeholder. Import this file if you need to
// rebuild the previous design in the future.
