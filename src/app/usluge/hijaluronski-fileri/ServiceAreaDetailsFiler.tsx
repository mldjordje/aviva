    ...
    <>
      ...
      <section>
        <div className="container">
          ...
          >
            <h4 className="anim_heading_title cs_detail_heading">
              <img
            ...
            <p className="cs_mp0 anim_text">
              ...
              Ageless Niš, posebnu pažnju posvećujemo hijaluronskim filerima za usne kako bi svaki tretman
          ...
          >
            <h4 className="anim_heading_title cs_detail_heading">
              <img
                src="/assets/icon/ikonica.png"
                alt="Naš pristup - ikonica"
                loading="lazy"
                className="cs_detail_icon"
              />
              Naš pristup usnama
          ...
          >
            ...
            <div className="cs_card_work cs_style_1 cs_detail_grid">
              {regije_data.map((item, i) => (
                <motion.div
                  key={i}
                  className="cs_card cs_mt_nthchild_0 cs_detail_grid_item"
                  initial={{ opacity: 0, x: -50 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true, amount: 0.2 }}
            ...
            <h4 className="anim_heading_title cs_mt_40">
              Svaka aplikacija počinje detaljnom analizom lica i konsultacijom sa Dr Milom Đorđević i timom, kako bi
              se odredile najbolje tehnike i količine filera za optimalan rezultat.
            </h4>
          </motion.div>
