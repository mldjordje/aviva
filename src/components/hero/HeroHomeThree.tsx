...
const HeroHomeThree = () => {
  ...
  // Transformiramo scrollYProgress u skalu slike
  ...
  return (
    <>
      <section ref={sectionRef}>
        <div
          className="cs_hero cs_style2"
          style={{ position: "relative", overflow: "hidden" }}
        >
          {/* Pozadina sa scroll animacijom */}
          <motion.div
          ...
          >
            <div className="cs_hero_text">
              ...
              >
                <h1
                  className="cs_hero_title cs_hero_title_lg"
